...
Given the considerations discussed in \S\ref{dat}, the final samples were then suitable for covering the full range of comoving separations for measuring the real-space correlation function of quasars at $z\sim 1.55$.  Here we summarize the steps taken in clustering measurement and the 


\subsection{kpc-scale clustering}\label{kpcls}
The method for measuring the volume-averaged correalation function in real scape with sparse samples of close pairs is discussed in detail in \citet{ef17} and \citet{Hen06}. The $43.3 \lesssim r_p \lesssim 92.3 \, \rm h^{-1}kpc$.
