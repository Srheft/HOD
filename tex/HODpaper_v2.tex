...
%alternative titiles;
% On the one-halo term of the quasar HOD: are we heading for a reform
% On the one-halo term of the quasar HOD: it is time for a reform?
% 
...
sets of observations at $z \sim 1.5$ at small ($\rm kpc$) and large ($\rm Mpc$) 
scales. The best-fit parameters in the three-parameter fit are : $\Delta_{\rm 
m}= 1.10_{-0.31}^{+0.24}$, $\rm M_{m} = 7.87_{-3.75}^{+6.17} \times 10^{12}\, 
h^{-1} M_{\odot}$, and $f_{\rm sat} = 0.051_{-0.018}^{+0.017}$ with reduced 
$\chi^{2} = 1.023$ and for the two-parameter fit are : $\rm M_{m} = 
6.97_{-1.22}^{+4.96} \times 10^{12}\, h^{-1} M_{\odot}$, and $f_{\rm sat} = 
0.0289_{-0.0145}^{+0.0124}$ with reduced $\chi^{2} = 0.76$. Right: A 
...
\begin{figure*}
    \centering
        \begin{subfigure}{
        \centering
        \includegraphics[angle=0,scale=0.5]{cornerplot_SEP18_4KDE.eps}
        \includegraphics[angle=0,scale=0.5]{cornerplot_SEP18_ONLY1KDE.eps}}
        \caption{Left: The result of our 3-parameter Monte-Carlo fit to the projected 
two point correlation function over $ \sim 0.01-100 \, \rm h^{-1} Mpc$. Diagonal 
...
parameters. Right: }\label{fig5:cor}
       \end{subfigure}
\end{figure*}
