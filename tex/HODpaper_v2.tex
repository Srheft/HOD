...
Given the considerations discussed in \S\ref{dat}, the final samples were then suitable for covering the full range of comoving separations for measuring the real-space correlation function of quasars at $z\sim 1.55$.  Hee we summarize the steps taken in clustering measurement and the 
