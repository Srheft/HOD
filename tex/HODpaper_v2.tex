...
\section{Results and Discussion}\label{res}
 ...
 We investigated the effect of relaxing $\Delta_{\rm m}$ as the third parameter 
for the HOD model in addition to $f_{\rm sat}$ and $\rm M_{m}$ and t was proven 
to have to significant effect in changing the best fit model.
