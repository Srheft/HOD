...
The method for measuring the volume-averaged correlation function in real space with sparse samples of close pairs is discussed in detail in \citet{ef17} and \citet{Hen06}. Fig. 2 of \citet{ef17} shows how the sample of 47 pairs are positioned in the redshift-physical separation plane. We apply the redshift cut of $0.8 \lesssim z \lesssim 2.2$ and count the remaining pairs in linearly shifted bins of separation (i.e., to the comoving coordinates). This constitutes the origin of the closely separated bins in the measured correlation function shown in Fig.\ref{fig3:}
